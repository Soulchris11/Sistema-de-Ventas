...
namespace CapaPresentacion
{
    public partial class frmTrabajador : Form
    {
        ...
        public frmTrabajador()
        {
            ...
            this.ttMensaje.SetToolTip(this.txtPassword, "Ingrese la Password del Trabajador");
            this.ttMensaje.SetToolTip(this.cbAcceso, "Selecciones el Nivel de Acceso del Trabajador");
        }
