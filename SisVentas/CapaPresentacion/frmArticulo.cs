...
namespace CapaPresentacion
{
    public partial class frmArticulo : Form
    {
        ...
        public frmArticulo()
        {
            ...
            this.ttMensaje.SetToolTip(this.pxImagen, "Ingrese la imagen del Artículo");
            this.ttMensaje.SetToolTip(this.txtCategoria, "Ingrese la Categoría del Artículo");
            this.ttMensaje.SetToolTip(this.cbIdpresentacion, "Ingrese la Presentación del Artículo");
        ...
        private void Limpiar()
        {
            ...
            this.pxImagen.Image = global :: CapaPresentacion.Properties.Resources.shape86412073;
        }

        //Habilidad los controles del formulario
            ...
            try
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        imagen, Convert.ToInt32(this.txtidcategoria.Text), Convert.ToInt32(cbIdpresentacion.SelectedValue));
