...
namespace CapaPresentacion
{
    public partial class frmCliente : Form
    {
        ...
        public frmCliente()
        {
            ...
            this.ttMensaje.SetToolTip(this.txtApellidos, "Ingrese el Apellidos del Cliente");
            this.ttMensaje.SetToolTip(this.txtDireccion, "Ingrese el Dirección del Cliente");
